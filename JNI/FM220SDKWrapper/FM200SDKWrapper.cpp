...
#include <TCHAR.H>
#include "fm200api.h"
#include "com_startek_eng_fm220sdk_FM220SDKWrapper.h"
...
Java_com_startek_1eng_fm220sdk_FM220SDKWrapper_FP_1ConnectCaptureDriver(JNIEnv *env, jobject obj, jint reserved)
{
	jlong result=FAIL;
...
Java_com_startek_1eng_fm220sdk_FM220SDKWrapper_FP_1DisconnectCaptureDriver(JNIEnv *env, jobject obj, jlong handle)
{
...
Java_com_startek_1eng_fm220sdk_FM220SDKWrapper_FP_1Snap(JNIEnv *env, jobject obj, jlong handle)
{
	return FP_Snap((HCONNECT)handle);
}
//FP_CreateCaptureHandle
JNIEXPORT jlong JNICALL 
Java_com_startek_1eng_fm220sdk_FM220SDKWrapper_FP_1CreateCaptureHandle(JNIEnv *env, jobject obj, jlong handle)
{
	return (jlong)FP_CreateCaptureHandle((HCONNECT)handle);
}
//FP_Capture
JNIEXPORT jint JNICALL 
Java_com_startek_1eng_fm220sdk_FM220SDKWrapper_FP_1Capture(JNIEnv *env, jobject obj, jlong hConnect, jlong hFPCapture)
{
...
JNIEXPORT jint JNICALL 
Java_com_startek_1eng_fm220sdk_FM220SDKWrapper_FP_1DestroyCaptureHandle(JNIEnv *env, jobject obj,jlong hConnect, jlong hFPCapture)
{
...
JNIEXPORT jint JNICALL 
Java_com_startek_1eng_fm220sdk_FM220SDKWrapper_FP_1GetPrimaryCode(JNIEnv *env, jobject obj, jlong hConnect, jbyteArray pcode)
{
	jint result=-1;
	jboolean iscopy;
...
JNIEXPORT jint JNICALL 
Java_com_startek_1eng_fm220sdk_FM220SDKWrapper_FP_1GetTemplate(JNIEnv *env, jobject obj, jlong hConnect, jbyteArray pcode, jint mode, jint key)
{
	jint result=-1;
	jboolean iscopy;
...
JNIEXPORT jlong JNICALL 
Java_com_startek_1eng_fm220sdk_FM220SDKWrapper_FP_1CreateImageHandle(JNIEnv *env, jobject obj, jlong hConnect, jbyte bMode, jint wSize)
{
...
JNIEXPORT jint JNICALL 
Java_com_startek_1eng_fm220sdk_FM220SDKWrapper_FP_1GetImage(JNIEnv *env, jobject obj, jlong hConnect, jlong hFPImage)
{
...
JNIEXPORT jint JNICALL 
Java_com_startek_1eng_fm220sdk_FM220SDKWrapper_FP_1DestroyImageHandle(JNIEnv *env, jobject obj, jlong hConnect, jlong hFPImage)
{
...
JNIEXPORT jlong JNICALL 
Java_com_startek_1eng_fm220sdk_FM220SDKWrapper_FP_1CreateEnrollHandle(JNIEnv *env, jobject obj, jlong hConnect, jbyte mode)
{
...
JNIEXPORT jint JNICALL 
Java_com_startek_1eng_fm220sdk_FM220SDKWrapper_FP_1Enroll(JNIEnv *env, jobject obj, jlong hConnect, jlong hFPEnroll,jbyteArray pcode,jbyteArray fpcode)
{
	jint result=FAIL;
	jboolean iscopy;
	jbyte* m_pcode = (jbyte*) env->GetByteArrayElements(pcode,&iscopy);
...
JNIEXPORT jint JNICALL 
Java_com_startek_1eng_fm220sdk_FM220SDKWrapper_FP_1EnrollEx(JNIEnv *env, jobject obj, jlong hConnect, jlong hFPEnroll,jbyteArray pcode,jbyteArray fpcode,jint mode)
{
	jint result=FAIL;
	jboolean iscopy;
	jbyte* m_pcode = (jbyte*) env->GetByteArrayElements(pcode,&iscopy);
...
JNIEXPORT jint JNICALL 
Java_com_startek_1eng_fm220sdk_FM220SDKWrapper_FP_1DestroyEnrollHandle(JNIEnv *env, jobject obj, jlong hConnect, jlong hFPEnroll)
{
...
JNIEXPORT jint JNICALL 
Java_com_startek_1eng_fm220sdk_FM220SDKWrapper_FP_1ImageMatch(JNIEnv *env, jobject obj, jlong hConnect, jbyteArray fpcode, jint wSecutity)
{
	jint result=FAIL;
	jboolean iscopy;
...
JNIEXPORT jint JNICALL
Java_com_startek_1eng_fm220sdk_FM220SDKWrapper_FP_1CodeMatch(JNIEnv *env, jobject obj, jlong hConnect, jbyteArray pcode, jbyteArray fpcode, jint wSecutity)
{
	jint result=FAIL;
	jboolean iscopy;
...
JNIEXPORT jlong JNICALL
Java_com_startek_1eng_fm220sdk_FM220SDKWrapper_FP_1ImageMatchEx(JNIEnv *env, jobject obj, jlong hConnect, jbyteArray fpcode, jint wSecutity)
{
	jlong result =FAIL;
	jlong dwScore=0;
...
JNIEXPORT jlong JNICALL
Java_com_startek_1eng_fm220sdk_FM220SDKWrapper_FP_1CodeMatchEx(JNIEnv *env, jobject obj, jlong hConnect,jbyteArray pcode,jbyteArray fpcode, jint wSecutity)
{
	jlong result=FAIL;
	jlong dwScore=0;
	jboolean iscopy;
...
JNIEXPORT jint JNICALL 
Java_com_startek_1eng_fm220sdk_FM220SDKWrapper_FP_1CheckBlank(JNIEnv *env, jobject obj, jlong hConnect)
{
	return FP_CheckBlank((HCONNECT)hConnect);
}
//extern int WINAPI FP_Diagnose(HCONNECT hConnect);
JNIEXPORT jint JNICALL
Java_com_startek_1eng_fm220sdk_FM220SDKWrapper_FP_1Diagnose(JNIEnv *env, jobject obj, jlong handle)
{
...
JNIEXPORT jint JNICALL
Java_com_startek_1eng_fm220sdk_FM220SDKWrapper_FP_1SaveImage(JNIEnv *env, jobject obj, jlong hConnect, jlong hFPImage, jint wFileType, jstring Filename)
{
	jint result=FAIL;
//	jboolean iscopy;
	const char *mfile;
...
/*
 * Class:     com_startek_0005feng_fm220sdk_FM220SDKWrapper
 * Method:    FP_SaveISOImage
 * Signature: (JJILjava/lang/String;BB)I
 */
JNIEXPORT jint JNICALL 
Java_com_startek_1eng_fm220sdk_FM220SDKWrapper_FP_1SaveISOImage(JNIEnv *env, jobject obj, jlong hConnect, jlong hFPImage, jint wFileType, jstring Filename, jbyte compRatio, jbyte fpPos)
{
	jint result=FAIL;
//	jboolean iscopy;
	const char *mfile;
...
/*JNIEXPORT jint JNICALL 
Java_com_startek_1eng_fm220sdk_FM220SDKWrapper_FP_1DisplayImage(JNIEnv *env, jobject obj, jlong hConnect, jlong hDC, jlong hFPImage, jlong nStartX, jlong nStartY, jlong nWidth, jlong nHeight)
{
	jint result = FAIL;
...
JNIEXPORT jint JNICALL 
Java_com_startek_1eng_fm220sdk_FM220SDKWrapper_FP_1DisplayImage(JNIEnv *env, jobject obj, jlong hConnect, jobject canvas, jlong hFPImage, jint nStartX, jint nStartY, jshort nWidth, jshort nHeight)
{
	jint result = FAIL;
...
JNIEXPORT jint 
JNICALL Java_com_startek_1eng_fm220sdk_FM220SDKWrapper_FP_1GetImageData (JNIEnv *env, jobject obj, jlong hConnect, jbyteArray rawImageData, jshortArray imageWidthHeight)
{	
	jint result = FAIL;
	jboolean iscopy;
...
/*
 * Class:     com_startek_eng_fm220sdk_FM220SDKWrapper
 * Method:    createimage
 * Signature: ([BII)Ljava/awt/Image;
 */
JNIEXPORT jobject JNICALL Java_com_startek_1eng_fm220sdk_FM220SDKWrapper_createimage
...
//
JNIEXPORT jint 
JNICALL Java_com_startek_1eng_fm220sdk_FM220SDKWrapper_FP_1GetEnrollCode(JNIEnv *env, jobject obj, jlong hConnect,jbyteArray pcode,jbyteArray fpcode, jshort nWidth, jshort nHeight)
{
	jint result=FAIL;
	jboolean iscopy;
	jbyte* m_pcode = env->GetByteArrayElements(pcode,&iscopy);
...
JNIEXPORT jint 
JNICALL Java_com_startek_1eng_fm220sdk_FM220SDKWrapper_FP_1GetPrimaryCodeEx(JNIEnv *env, jobject obj, jlong hConnect, jbyteArray bRawData, jshort nWidth, jshort nHeight, jbyteArray p_code)
{
	jint result=FAIL;
	jboolean iscopy;
...
/*JNIEXPORT jint JNICALL 
Java_FM220SDKWrapper_testByteArray (JNIEnv *env, jobject obj, jbyteArray test_bytes)
{
	jboolean iscopy;
...
JNIEXPORT jint JNICALL 
Java_FM220SDKWrapper_testLongReference(JNIEnv *env, jobject obj, jobject tt)
{
...
JNIEXPORT jint JNICALL Java_com_startek_1eng_fm220sdk_FM220SDKWrapper_DLG_1FPEnroll
...
JNIEXPORT jint JNICALL Java_com_startek_1eng_fm220sdk_FM220SDKWrapper_DLG_1FPSnap
  (JNIEnv *env, jobject obj, jlong hConnect, jobject jcomponent, jbyteArray codeBuffer, jint codeLength)
{
	jint result=FAIL;
	jboolean iscopy;
...
JNIEXPORT jint JNICALL 
Java_com_startek_1eng_fm220sdk_FM220SDKWrapper_FP_1RawtoISOimage(JNIEnv *env, jobject obj, jlong hConnect, jbyteArray img_buf, jshort Img_Width, jshort Img_Height,jbyte ImgCompAlgo, jbyte FpPos, jbyteArray img_code)
{
	jint result=FAIL;
	jboolean iscopy;
...
JNIEXPORT jint JNICALL Java_com_startek_1eng_fm220sdk_FM220SDKWrapper_FP_1RawDataToBMP
...
JNIEXPORT jint JNICALL Java_com_startek_1eng_fm220sdk_FM220SDKWrapper_FP_1GetImageDimension(JNIEnv *env, jobject obj, jlong hConnect, jshortArray imageWidthHeight)
{
	jboolean iscopy;
	jshort* m_imageWidthHeight = env->GetShortArrayElements(imageWidthHeight,&iscopy);
...
JNIEXPORT jint JNICALL Java_com_startek_1eng_fm220sdk_FM220SDKWrapper_FP_1GetImageData
 ...
 */
JNIEXPORT jint JNICALL Java_com_startek_1eng_fm220sdk_FM220SDKWrapper_FP_1SaveISOminutia
 ...
 * Signature: (JLjava/lang/String;[B)I
 */
JNIEXPORT jint JNICALL Java_com_startek_1eng_fm220sdk_FM220SDKWrapper_FP_1LoadISOminutia
(JNIEnv *env, jobject obj, jlong hConnect, jstring Filename, jbyteArray minu_code){
	jint result = FAIL;
	const char *mfile;
	jboolean iscopy;
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_com_startek_1eng_fm220sdk_FM220SDKWrapper_FP_1GetImageQuality
