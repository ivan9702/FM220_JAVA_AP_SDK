package com.startek_eng.fm220sdk;
...
/**
 * Fm220SDKWrapper is the class designed for fingerprint capture device Fm220.
 ...
 */
public class FM220SDKWrapper
{
	private FM220SDKWrapper() throws SensorConnectFailedException, LibraryLoadFailedException
	{
		super();
		loadRelatedLibrary();
		try
	...
	/** 
     * getInstance get a singlton instance of FM220SDKWrapper
     */
	public static FM220SDKWrapper getInstance() throws SensorConnectFailedException,LibraryLoadFailedException
	{
		if (_instance == null)
		{
			_instance = new FM220SDKWrapper();
		}
		return _instance;
	}
	...
	private static FM220SDKWrapper _instance = null;
	private static long _h_sensorconnect=-1;
	//private static final String defaultLibarys[] = {"FingerPrinterDll.dll","fm220drv.dll","fm220api.dll","FM220SDKWrapper.dll"};
	//private static final String defaultLibarys[] = {"FingerPrinterDll.dll","fm220drv.dll","fm220api.dll","FM220SDKWrapper.dll"};
	//private static final String defaultLibarys[] = {"fm220drv.dll","fm220api.dll","FM220SDKWrapper.dll"};
	private static final String defaultLibarys[] = {"fpImgQ.dll","fm220drv.dll","fm220api.dll","FM220SDKWrapper.dll"};
	...
	private static void loadRelatedLibrary() throws LibraryLoadFailedException
	{
		...
		}
		{
			...
			for (Iterator i=tmpLibArray.iterator();i.hasNext()&&loadOK==OK;)
			{
				...
				in = FM220SDKWrapper.class.getResourceAsStream("lib/"+tmpStr);
				...
				if (in!=null)
				{
					try
					{
						...
						if (placePath==null)
						{
							...
							placePath = placePath.substring(0,placePath.lastIndexOf(tmpStr))+"STARTEK_FM220/";
